...
public:
    ...
    */
    constexpr inline std::uint16_t htons(std::uint16_t value) const
    {
    ...
    */
    constexpr inline std::uint32_t htonl(std::uint32_t value) const
    {
    ...
    */
    constexpr inline std::uint64_t htonll(std::uint64_t value) const
    {
    ...
    */
    constexpr inline std::uint16_t ntohs(std::uint16_t value) const
    {
        return htons(value);
    }
    ...
    */
    constexpr inline std::uint32_t ntohl(std::uint32_t value) const
    {
        return htonl(value);
    }
    ...
    */
    constexpr inline std::uint64_t ntohll(std::uint64_t value) const
    {
        return htonll(value);
    }
}; // class endianness
